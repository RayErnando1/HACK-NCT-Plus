#decompiled by PDM31
import os, sys
print '\x1b[1;32mMasukan ID: newcraventeam dan Password: newcraventeam10 untuk Login dan jangan lupa login facebook di OperaMini dulu sebelum login agar tidak CekPoint'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6285161006009&text=Assalamualaikum')
...
if sandi == 'newcraventeam10' and user == 'newcraventeam':
