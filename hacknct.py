import os, sys
print '\x1b[1;32mMasukan ID: newcraventeam dan Password: newcraventeam untuk Login dan jangan lupa login facebook di OperaMini dulu sebelum login agar tidak CekPoint'
...
if sandi == 'newcraventeam' and user == 'newcraventeam':
